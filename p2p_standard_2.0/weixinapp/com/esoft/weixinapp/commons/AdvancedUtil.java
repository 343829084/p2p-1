...
import com.esoft.weixinapp.domain.WeixinGroup;
import com.esoft.weixinapp.domain.WeixinMedia;
import com.esoft.weixinapp.domain.WeixinOauth2Token;
import com.esoft.weixinapp.domain.WeixinQRCode;
import com.esoft.weixinapp.domain.WeixinUserInfo;
import com.esoft.weixinapp.domain.WeixinUserList;
import com.esoft.weixinapp.message.respone.Article;
import com.esoft.weixinapp.message.respone.Music;
...
public class AdvancedUtil {
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getAccessToken().getToken();

		/**
		 * 发送客服消息（文本消息）
		 */
		// 组装文本客服消息
		String jsonTextMsg = makeTextCustomMessage("", "点击查看<a href=\"http://blog.csdn.net/lyq8479\">柳峰的博客</a>");
		// 发送客服消息
