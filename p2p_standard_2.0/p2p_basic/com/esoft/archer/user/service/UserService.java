...
public interface UserService {
	 ...
	 */
	public void activateUserByEmailActiveCode(String activeCode) throws UserNotFoundException, NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 */
	@Deprecated
	public void sendFindLoginPasswordEmail(String email) throws UserNotFoundException;
	 ...
	 * @throws UserNotFoundException
	 */
	public void sendFindLoginPasswordLinkEmail(String email) throws UserNotFoundException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public User verifyFindLoginPasswordActiveCode(String activeCode) throws UserNotFoundException, NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void realNameCertification(User user, String authCode) throws NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 * @throws UserNotFoundException
	 */
	public void sendBindingMobileNumberSMS(String userId, String mobile) throws UserNotFoundException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void bindingEmail(String userId, String email, String authCode) throws UserNotFoundException, NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void bindingMobileNumber(String userId, String mobileNumber, String authCode) throws UserNotFoundException, NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 * @throws UserNotFoundException
	 */
	public void sendChangeBindingMobileNumberSMS(String userId, String oriMobileNumber) throws UserNotFoundException;
	 ...
	 * @throws UserNotFoundException
	 */
	public void sendChangeBindingEmail(String userId, String oriEmail) throws UserNotFoundException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void registerByMobileNumber(User user, String authCode) throws NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void registerByMobileNumber(User user, String authCode, String referrer) throws NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	 ...
	 * @throws AuthInfoAlreadyActivedException 
	 */
	public void realNameCertificationByEmail(User user, String authCode) throws NoMatchingObjectsException, AuthInfoOutOfDateException, AuthInfoAlreadyActivedException;
	...
	public void refreshAuthorities(String userId);// 刷新登录用户权限
}
