...
public class UserWealthHome extends EntityHome<UserWealth> {

	@Logger
	private static Log log;

	@Resource
	private UserWealthService ubs;

	@Resource
	private RechargeService rechargeService;

	@Resource
	private CapWithdrawCashService capitalPoolwithdrawCashService;
	...
	@Override
	protected UserWealth createInstance() {
		UserWealth wealth = new UserWealth();
		wealth.setUser(new User());
		return wealth;
	}
	...
	public String managerUserBill() {
		...
		try {
			if (this.getInstance().getType().equals("管理员-充值")) {
				...
				capitalPoolwithdrawCashService.withdrawByAdmin(getInstance());
		...
		return FacesUtil.redirect("/admin/fund/userWealthList");
	}
