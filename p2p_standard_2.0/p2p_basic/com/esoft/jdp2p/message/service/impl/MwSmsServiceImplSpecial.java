...
@Service("smsService")
public class MwSmsServiceImplSpecial extends SmsService {
	private String wsAdress ="http://61.135.198.131:8023/MWGate/wmgw.asmx/MongateSendSubmit?userId=CPID&password=CPPWD&pszMobis=PHONE&pszMsg=MSGCONT&iMobiCount=1&pszSubPort=*&MsgId=0";
	...
	static{
		try {
			...
			cpid = props.getProperty("cpid");
			cppwd = props.getProperty("cppwd");
...
public static void main(String[] args) {
	...
	//18210122448
	new MwSmsServiceImplSpecial().send("好友来投的用户，您好！感谢您注册好友来投，注册验证码为23456111111，请在页面填写验证码完成验证，非常感谢您的支持与合作。", "15510492893");
}
