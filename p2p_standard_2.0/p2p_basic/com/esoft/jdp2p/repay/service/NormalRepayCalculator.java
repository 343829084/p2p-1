...
public interface NormalRepayCalculator {
	 ...
	 * @param rate 年利率
	 * @param deadline 总期数
	 * @param repayTimeUnit 还款账单（天、月），还款周期的最小单位
	 * @param repayTimePeriod 还款周期 （两天，三月之类）
	 * @param interestBeginTime 开始计息时间
	 * @param interestType 计息方式（按天、按月）
	 * @param customPeriods 完全自定义还款总期数、每期还款时间、每期还款本金所占全部本金的百分比 
	 * @return 还款数据
	 */
...
//			Date interestBeginTime, String interestType, String interestBeginPoint, List<RepayCustomPeriod> customPeriods);
	 ...
	 * @return 还款数据
	 */
	public List<Repay> generateRepays(double investMoney, Date investTime, double rate,
			Integer deadline, String repayTimeUnit, Integer repayTimePeriod,
			Date interestBeginTime, String interestType, String interestBeginPoint, List<RepayCustomPeriod> customPeriods);
